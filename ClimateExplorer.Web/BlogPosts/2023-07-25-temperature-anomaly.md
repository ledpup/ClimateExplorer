...
Once we're happy that this technique works well with some missing data (hopefully much less than 25%!), we can use it to aggregate not just Darwin and Hobart, but whole regions and ultimately, the world. [ClimateExplorer](https://climateexplorer.net/) has recently applied these calculations for [all of Australia](https://climateexplorer.net/global?csd=AverageOfAnomaliesInRegion,b13afcaf-cdbc-4267-9def-9629c8066321*TempMax*Adjusted*143983a0-240e-447f-8578-8daf2c0a246a,Mean,AutoAssigned,ByYear,Line,False,None,False,MovingAverage,20,Anomaly,,False,Identity,,True;AverageOfAnomaliesInRegion,e5eea4d6-5fd5-49ab-bf85-144a8921111e*Precipitation**143983a0-240e-447f-8578-8daf2c0a246a,Sum,AutoAssigned,ByYear,Line,False,None,False,MovingAverage,20,Anomaly,,False,Identity,,True).
