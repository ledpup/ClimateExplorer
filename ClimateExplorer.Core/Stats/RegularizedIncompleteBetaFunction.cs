...
/// <summary>
/// The regularized incomplete beta function I_x(a, b), shared by <see cref="StudentTDistributionCalculator"/>
/// (the per-coefficient t-distribution, used for standard errors/confidence intervals) and
/// <see cref="FDistributionCalculator"/> (the overall-model F-test, used for significance). Both
/// distributions' CDFs reduce to this same function - factored out once rather than duplicated,
/// since the two calculators are two views of the same underlying maths (a t-statistic squared is
/// an F-statistic with one numerator degree of freedom).
/// </summary>
internal static class RegularizedIncompleteBetaFunction
{
