...
internal sealed class DataSetFreshnessPolicy(TimeProvider timeProvider)
{
    public bool IsFresh(ICachedData cachedData, DataResolution dataResolution)
    {
        ...
        return cachedData.RetrievedDate.Value > timeProvider.GetUtcNow().Subtract(maximumAge);
    }
}
