...
public interface IDataService
{
    ...
    Task<IEnumerable<DataSet>> GetDataSet(DataType dataType, DataResolution resolution, MeasurementType measurementType, Guid locationId, short? year = null, short? dayGrouping = 14, float? dayGroupingThreshold = .7f, bool? relativeToAverage = false);
