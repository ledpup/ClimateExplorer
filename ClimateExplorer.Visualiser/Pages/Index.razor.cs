...
<p><strong>Clear override</strong>: this will reset the settings back to their default (14 days at 70% threshold). Only appears after applying your settings.</p>";
    ...
    protected async Task BuildDataSets()
    {
        ...
        else
        {
            ...
            ShowLocation = ChartSeriesWithData != null && ChartSeriesWithData.Any(x => x.SourceDataSet.DataType == DataType.TempMax || x.SourceDataSet.DataType == DataType.TempMin || x.SourceDataSet.DataType == DataType.Rainfall || x.SourceDataSet.DataType == DataType.SolarRadiation);
